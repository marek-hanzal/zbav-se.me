...
import { FavouriteSchema } from "~/buyer/favourite/server/schema/FavouriteSchema";
...
export const favouriteCreateFn = createServerFn({
	method: "POST",
})
	.middleware([
		withLogMiddleware,
	...
	.inputValidator(FavouriteCreateSchema)
