...
export const toolListingCollection = tool({
	...
	description: `
        ...
        Prefer category, location/range, price, delivery, warranty, favourite, ignored, feed, or transaction filters when available. The tool caps results to a small page.
