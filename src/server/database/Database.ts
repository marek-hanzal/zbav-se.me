...
import type { ListingFavouriteTableSchema } from "~/server/database/@table/ListingFavouriteTableSchema";
import type { ListingFlagTableSchema } from "~/server/database/@table/ListingFlagTableSchema";
import type { ListingIgnoreTableSchema } from "~/server/database/@table/ListingIgnoreTableSchema";
...
import type { ResourceBundleFeatureStripeTableSchema } from "~/server/database/@table/ResourceBundleFeatureStripeTableSchema";
...
export interface Database {
	...
	resource_bundle_feature_stripe: ResourceBundleFeatureStripeTableSchema.Type;
