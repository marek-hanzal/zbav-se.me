...
export const ListingAttrOfSchema = z.union([
	TextFieldSchema,
	DecimalFieldSchema,
	NumberFieldSchema,
	YearFieldSchema,
...
export type ListingAttrOfSchema = typeof ListingAttrOfSchema;

export namespace ListingAttrOfSchema {
	export type Type = z.infer<ListingAttrOfSchema>;
}
