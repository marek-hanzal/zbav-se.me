...
export namespace withListingPingFn {
	export type Error = Effect.Effect.Error<withListingPingFx>;
}

export const withListingPingFn = createServerFn()
	.middleware([
		withLogMiddleware,
