...
- Buyer transaction detail root component now lives in active scope at `@buyer/transaction/ui/Transaction.tsx`; the remaining detail sub-parts still temporarily stay in `v0`.
