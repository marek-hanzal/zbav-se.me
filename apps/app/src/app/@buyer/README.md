...
- Buyer transaction detail root component and toolbar now live in active scope at `@buyer/transaction/ui/*`; the remaining detail sub-parts still temporarily stay in `v0`.
