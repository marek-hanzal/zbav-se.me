...
- Draft list now follows local suspense composition in `-user/draft/ui/DraftList/`: `DraftList.tsx` is the suspense wrapper, `Data.tsx` owns query + page content, and `Pending.tsx` mirrors route shell loading state.
