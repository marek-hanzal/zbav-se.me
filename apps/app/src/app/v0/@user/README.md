...
- Home draft CTA suspense is now encapsulated in `@user/home/HomeMenu/HomeMenuDraftLink/HomeMenuDraftLink.tsx` so menu call-sites avoid inline suspense wiring.
