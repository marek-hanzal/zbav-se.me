...
- Seller transaction detail root component, toolbar, and chat now live in active scope at `@seller/transaction/ui/*`; the remaining detail sub-parts still temporarily stay in `v0`.
