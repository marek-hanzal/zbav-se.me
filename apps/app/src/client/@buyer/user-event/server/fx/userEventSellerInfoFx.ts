...
import type { UserEventSellerSchema } from "~/client/@buyer/user-event/server/schema/UserEventSellerSchema";
import { computeActivity } from "~/client/@user/user-event/server/fx/computeActivity";
import { computeLoad } from "~/client/@user/user-event/server/fx/computeLoad";
import { userEventCollectionFx } from "~/client/@user/user-event/server/fx/userEventCollectionFx";
import type { ActivityEnumSchema } from "~/client/@user/user-event/server/schema/ActivityEnumSchema";
import type { LoadEnumSchema } from "~/client/@user/user-event/server/schema/LoadEnumSchema";
