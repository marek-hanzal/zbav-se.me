...
import { draftGalleryCreateFx } from "~/client/@seller/draft-gallery/server/fx/draftGalleryCreateFx";
import { DraftGalleryCreateSchema } from "~/client/@seller/draft-gallery/server/schema/DraftGalleryCreateSchema";
