...
import type { UserEventSellerSchema } from "~/server/@buyer/user-event/schema/UserEventSellerSchema";
import { computeActivity } from "~/server/@common/user-event/fx/computeActivity";
import { computeLoad } from "~/server/@common/user-event/fx/computeLoad";
import { userEventCollectionFx } from "~/server/@common/user-event/fx/userEventCollectionFx";
