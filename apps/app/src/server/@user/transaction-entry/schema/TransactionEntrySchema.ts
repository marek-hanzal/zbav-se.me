...
import { CommonSchema } from "~/server/database/@table/TransactionEntryTableSchema/CommonSchema";
import { GallerySchema } from "~/server/database/@table/TransactionEntryTableSchema/GallerySchema";
import { LocationSchema } from "~/server/database/@table/TransactionEntryTableSchema/LocationSchema";
import { PackageSchema } from "~/server/database/@table/TransactionEntryTableSchema/PackageSchema";
import { PersonalSchema } from "~/server/database/@table/TransactionEntryTableSchema/PersonalSchema";
import { TextSchema } from "~/server/database/@table/TransactionEntryTableSchema/TextSchema";
