...
import { transactionListingCountFx } from "~/@seller-user/transaction-listing/fx/transactionListingCountFx";
import { TransactionListingCountQuerySchema } from "~/@seller-user/transaction-listing/schema/TransactionListingCountQuerySchema";
	...
	sellerUserHono.openapi(
		...
		async (c) => {
			...
			return Effect.gen(function* () {
				...
				withLoggingFx(axiomConfig, "apiTransactionListingCount"),
