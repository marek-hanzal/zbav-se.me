...
import { flagCountFx } from "~/@buyer/flag/fx/flagCountFx";
import { FlagCountQuerySchema } from "~/@buyer/flag/schema/FlagCountQuerySchema";
	...
	buyerHono.openapi(
		...
		async (c) => {
			...
			return Effect.gen(function* () {
				...
				withLoggingFx(axiomConfig, "apiFlagCount", c.get("traceId")),
				withCatchFx({
					ZodErrorFx({ zod }) {
