...
import { ignoreCountFx } from "~/@buyer/ignore/fx/ignoreCountFx";
import { IgnoreCountQuerySchema } from "~/@buyer/ignore/schema/IgnoreCountQuerySchema";
	...
	buyerHono.openapi(
		...
		async (c) => {
			...
			return Effect.gen(function* () {
				...
				withLoggingFx(axiomConfig, "apiIgnoreCount", c.get("traceId")),
				withCatchFx({
					ZodErrorFx({ zod }) {
