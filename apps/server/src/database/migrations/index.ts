...
import { MessageDateMigration } from "./0026-message-date";
import { TransactionMigration } from "./0027-transaction";
import { TransactionStatusMigration } from "./0028-transaction-status";
import { GitHubMigration } from "./0029-github";
import { FeedbackMigration } from "./0030-feedback";
...
export const migrations = {
	...
	"0026-message-date": MessageDateMigration,
	"0027-transaction": TransactionMigration,
	"0028-transaction-status": TransactionStatusMigration,
	"0029-github": GitHubMigration,
	"0030-feedback": FeedbackMigration,
} as const;
