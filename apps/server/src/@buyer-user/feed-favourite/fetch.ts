...
import { feedFavouriteFetchFx } from "~/@buyer-user/feed-favourite/fx/feedFavouriteFetchFx";
import { FeedFavouriteSchema } from "~/@buyer-user/feed-favourite/schema/FeedFavouriteSchema";
		...
		async (c) => {
			...
			return Effect.gen(function* () {
				...
				yield* Effect.annotateLogsScoped({
					endpoint: "apiFeedFavouriteFetch",
					userId: user.id,
				});
				...
				withLoggingFx(axiomConfig, "apiFeedFavouriteFetch"),
				withCatchFx({
					NotFoundErrorFx() {
