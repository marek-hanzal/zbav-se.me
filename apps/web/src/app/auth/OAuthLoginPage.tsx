...
const withContinueOAuth = async (query: Record<string, string>) => {
...
export const OAuthLoginPage = ({ query }: OAuthLoginPage.Props) => {
	const signInMutation = withEmailSignInMutation.useMutation({
		async onPostMutation() {
			return withContinueOAuth(query);
		},
	});
