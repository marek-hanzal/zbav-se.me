...
export const apiListingCreateResponse = zod.object({
...
export const apiListingFetchResponse = zod
	.object({
		id: zod.string().describe("ID of the listing"),
		userId: zod.string().describe("ID of the user who created the listing"),
		price: zod.number().nullable().describe("Price of the listing"),
...
export const apiListingGalleryUploadBody = zod.union([
	zod.object({
		type: zod.enum([
	...
	zod.object({
		...
		payload: zod.object({
			blob: zod.object({
				...
				size: zod
					.number()
					.min(apiListingGalleryUploadBodyPayloadBlobSizeMin),
...
export const apiListingGalleryUploadResponse = zod.union([
	zod.object({
		type: zod.enum([
			"blob.generate-client-token",
		]),
