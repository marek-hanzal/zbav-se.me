...
import type { apiFeedPatchError, tApiFeedPatchResponse, tFeedPatch } from "../../api/session/types.gen";
...
export const withFeedPatchMutation = withMutation<tFeedPatch, tApiFeedPatchResponse[200], apiFeedPatchError>({
	keys(variables) {
		return [
			"feed",
			"patch",
