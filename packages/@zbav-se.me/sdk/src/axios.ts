...
/**
 * Sort order for location sorting
 * @nullable
 */
export type Order = typeof Order[keyof typeof Order] | null;
...
export type ListingParamsGeo = {
  /** Reference to a location for location sorting */
  locationId: string;
  sort?: Order;
};

/**
 * Extended parameters for listings
 * @nullable
 */
export type ListingParams = {
  geo?: ListingParamsGeo;
} | null;
 ...
 */
export const apiLocationAutocomplete = <TData = AxiosResponse<Location[] | Location[]>>(
...
export type ApiLocationAutocompleteResult = AxiosResponse<Location[] | Location[]>
