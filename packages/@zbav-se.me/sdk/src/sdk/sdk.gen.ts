 ...
 */
export const apiMigrationRun = <ThrowOnError extends boolean = false>(options?: Options<tApiMigrationRunRequest, ThrowOnError>) => {
    return (options?.client ?? client).get<tApiMigrationRunResponse, unknown, ThrowOnError>({
        requestValidator: async (data) => {
 ...
 */
export const apiJanitorCleanup = <ThrowOnError extends boolean = false>(options?: Options<tApiJanitorCleanupRequest, ThrowOnError>) => {
    return (options?.client ?? client).get<tApiJanitorCleanupResponse, apiJanitorCleanupErrors, ThrowOnError>({
        requestValidator: async (data) => {
