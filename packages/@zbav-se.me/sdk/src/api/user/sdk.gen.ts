 ...
 */
export const apiTransactionMessageDateCreate = <ThrowOnError extends boolean = false>(options?: Options<tApiTransactionMessageDateCreateRequest, ThrowOnError>) => (options?.client ?? client).post<tApiTransactionMessageDateCreateResponse, apiTransactionMessageDateCreateErrors, ThrowOnError>({
    requestValidator: async (data) => await zApiTransactionMessageDateCreateData.parseAsync(data),
    responseType: 'json',
    responseValidator: async (data) => await zApiTransactionMessageDateCreateResponse.parseAsync(data),
