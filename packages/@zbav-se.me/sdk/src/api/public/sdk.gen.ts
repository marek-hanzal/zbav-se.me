...
/**
 * Returns TransactionEntryKind enum values
 */
export const apiPublicEnumTransactionEntryKind = <ThrowOnError extends boolean = false>(options?: Options<tApiPublicEnumTransactionEntryKindRequest, ThrowOnError>) => (options?.client ?? client).get<tApiPublicEnumTransactionEntryKindResponse, unknown, ThrowOnError>({
    requestValidator: async (data) => await zApiPublicEnumTransactionEntryKindData.parseAsync(data),
    responseType: 'json',
    responseValidator: async (data) => await zApiPublicEnumTransactionEntryKindResponse.parseAsync(data),
