...
type SchemaRow<TOutputSchema extends z.ZodTypeAny> = Elem<
	NonNullish<z.infer<TOutputSchema>>
>;

// Klíče řádku ze schématu
type SchemaRowKeys<TOutputSchema extends z.ZodTypeAny> =
	keyof SchemaRow<TOutputSchema>;
