...
>(
	...
	{ contract, definition }: Pick<Cls.Type<TContract>, "contract" | "definition">,
	...
	let current: Contract.Type<Token.Type, Slot.Type, Variant.Type> | undefined = contract;
	let currentDef:
	...
	while (current && currentDef) {
		...
		current = current["~use"] as Contract.Type<Token.Type, Slot.Type, Variant.Type> | undefined;
