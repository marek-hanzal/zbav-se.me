...
export namespace Cls {
	...
	export interface Type<TContract extends Contract.Any> {
		...
		>(
			...
			definition: Definition.Type<Contract.Type<TToken, TSlot, TVariant, TContract>>,
	...
	> = Variant.Raw<TCls["contract"]>[TVariant] extends readonly (infer U extends string)[]
		? Utils.Value<U>
		: never;

	export type VariantsOf<TCls extends Type<any>> = Variant.Optional<TCls["contract"]>;

	export type TweaksOf<TCls extends Type<any>> = Tweak.Tweaks<TCls["contract"]>;
