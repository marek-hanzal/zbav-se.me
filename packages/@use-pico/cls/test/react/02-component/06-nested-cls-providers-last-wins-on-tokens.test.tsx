...
describe("react/02-component/nested-cls-providers-last-wins-on-tokens", () => {
	it("TokenProvider overrides component tokens and nested providers work correctly", () => {
		...
		const root1 = container1.querySelector('[data-ui="Badge-root"]') as HTMLElement;
		...
		const root2 = container2.querySelector('[data-ui="Badge-root"]') as HTMLElement;
		expect(root2?.className).toBe("theme-provider-a-primary badge-default-base");
		...
		const root3 = container3.querySelector('[data-ui="Badge-root"]') as HTMLElement;
		expect(root3?.className).toBe("theme-provider-b-primary badge-default-base");
	});
});
