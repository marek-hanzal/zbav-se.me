...
describe("Inheritance Partial Override", () => {
	it("should allow partial slot overrides through inheritance", () => {
		...
		expect(result.slots.root()).toBe("custom-card bg-blue-50 border-blue-200 rounded-xl");
		expect(result.slots.header()).toBe("custom-header p-6 font-bold text-blue-900");
