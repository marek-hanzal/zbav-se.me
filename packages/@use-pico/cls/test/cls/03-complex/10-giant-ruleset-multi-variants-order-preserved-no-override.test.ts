...
describe("cls/complex/giant-ruleset-multi-variants-order-preserved-no-override", () => {
	it("large matrix of variant matches across 3 slots keeps strict order", () => {
		...
		expect(slots.icon()).toBe("i-sm i-dark i-hover i-on i-sm-dark i-dark-hover i-base");
		expect(slots.label()).toBe("l-sm l-dark l-hover l-on l-sm-dark l-dark-hover l-base");
	});
});
