...
describe("seller transactionAckFx", () => {
	it("archives only scoped buyer-message activity for the requested transaction", async () => {
		const database = await testabase("seller-transactionAckFx-scoped");
