...
2. Extend base UI props where appropriate (`Container.Props`, `Button.Props`, ...).
3. Merge default `ui` with caller `ui` (`...ui` last).
4. Keep wrappers pass-through friendly with `...props`.
5. Use small `hooks` prop objects when there are multiple callbacks.
